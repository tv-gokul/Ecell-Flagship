...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.y = (this.viewport.height * (1000 * this.scale * scaleFactor)) / this.screen.height;
    this.plane.scale.x = (this.viewport.width * (850 * this.scale * scaleFactor)) / this.screen.width;
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: flagship1, text: '' },
      { image: flagship2, text: '' },
      { image: flagship3, text: '' },
      { image: speaker1, text: '' },
      { image: speaker2, text: '' },
      { image: speaker3, text: '' }
    ];
